...
<div class="span-11 last">
    ...
    <table>
        <tr>
            ...
            <td> <?php echo CHtml::textField('usersTable', Yii::app()->controller->module->usersTable); ?> </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td> <?php echo CHtml::textField('profileFieldsTable', Yii::app()->controller->module->profileFieldsTable); ?> </td>
        </tr>
        <tr>
            <td> Table for the Profiles</td>
            <td> <?php echo CHtml::textField('profileTable', Yii::app()->controller->module->profileTable); ?> </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td> <?php echo CHtml::textField('userRoleTable', Yii::app()->controller->module->userRoleTable); ?> </td>
        </tr>
    </table>
