...
(function ($) {
    ...
    $.xheditor = function (textarea, options) {
        ...
        this.uploadInit = function (jText, tourl, upext) {
            ...
            if (tourl.substr(0, 1) == '!')//自定義上傳管理頁
            {
                jUpBtn.click(function () {
                    ...
                    _this.showIframeModal('上傳文件', tourl.substr(1), setUploadMsg, null, null, function () {
                        bShowPanel = true;
                    });
                });
            }
            ...
            function startUpload(fromfiles) {
                ...
                bShowPanel = false;//防止按鈕面板被關閉
                _this.showModal('文件上傳中(Esc取消上傳)', jUploadTip, 320, 150, function () {
                    bShowPanel = true;
                    upload.remove();
                });
                upload.start();
        ...
        this.showDialog = function (content) {
            ...
            }, 10);//定位首個可見輸入表單項,延遲解決opera無法設置焦點
        }
