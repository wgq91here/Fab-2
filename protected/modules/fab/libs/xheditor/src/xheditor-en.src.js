...
(function ($) {
    ...
    var htmlAbout = '<div style="font:12px Arial;width:245px;word-wrap:break-word;word-break:break-all;"><p><span style="font-size:20px;color:#1997DF;">xhEditor</span><br />v1.0.0 RC3 (build 100506)</p><p>xhEditor is a platform independent WYSWYG XHTML editor based by jQuery,released as Open Source under <a href="http://www.gnu.org/licenses/lgpl.html" target="_blank">LGPL</a>.</p><p>Copyright © <a href="http://xheditor.com/" target="_blank">xhEditor.com</a>. All rights reserved.</p></div>';
    ...
    $.xheditor = function (textarea, options) {
        ...
        this.init = function () {
            ...
            //添加工具栏
            _jTools.append(sToolHtml).bind('mousedown contextmenu', function () {
                return false;
            });
        ...
        this.remove = function () {
            _this.hidePanel();
            _this.saveResult();//卸载前同步最新内容到textarea
            //取消绑定事件
        ...
        this.formatXHTML = function (sHtml, bFormat) {//By John Resig
        ...
        this.showMenu = function (menuitems, callback) {
            ...
            $.each(menuitems, function (n, v) {
                arrItem.push('<a href="javascript:void(0);" title="' + (v.t ? v.t : v.s) + '" v="' + v.v + '">' + v.s + '</a>');
            });
            jMenu.append(arrItem.join(''));
            jMenu.click(function (ev) {
                callback($(ev.target).closest('a').attr('v'));
                _this.hidePanel();
                return false;
            }).mousedown(function () {
                return false;
        ...
        this.uploadInit = function (jText, tourl, upext) {
            ...
            if (tourl.substr(0, 1) == '!')//自定义上传管理页
            {
                jUpBtn.click(function () {
                    ...
                    _this.showIframeModal('Upload file', tourl.substr(1), setUploadMsg, null, null, function () {
                        bShowPanel = true;
                    });
                });
            }
            ...
            {
                jText.closest('.xheDialog').bind('dragenter dragover',function () {
                    return false;
            ...
            function startUpload(fromfiles) {
                ...
                if (fromfiles.nodeType && !((fileList = fromfiles.files) && fileList[0])) {
                    ...
                    if (!upMultiple && len > 1) {
                        alert("Please do not upload multiple files.");
                        return;
                    }
                ...
                bShowPanel = false;//防止按钮面板被关闭
                _this.showModal('File uploading(Esc cancel)', jUploadTip, 320, 150, function () {
                    bShowPanel = true;
                    upload.remove();
                });
                upload.start();
        ...
        this.showDialog = function (content) {
            ...
            if (!isIE)setTimeout(function () {
                jDialog.find('input[type=text],textarea').filter(':visible').filter(function () {
