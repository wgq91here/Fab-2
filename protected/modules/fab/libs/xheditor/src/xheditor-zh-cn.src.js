...
(function ($) {
    ...
    var arrFontsize = [
        {n: 'xx-small', wkn: 'x-small', s: '8pt', t: '极小'},
        ...
        {n: 'xx-large', wkn: '-webkit-xxx-large', s: '36pt', t: '极大'}
    ];
    var menuAlign = [
        {s: '左对齐', v: 'justifyleft'},
    ...
    var htmlAbout = '<div style="font:12px Arial;width:245px;word-wrap:break-word;word-break:break-all;"><p><span style="font-size:20px;color:#1997DF;">xhEditor</span><br />v1.0.0 RC3 (build 100506)</p><p>xhEditor是基于jQuery开发的跨平台轻量XHTML编辑器，基于<a href="http://www.gnu.org/licenses/lgpl.html" target="_blank">LGPL</a>开源协议发布。</p><p>Copyright © <a href="http://xheditor.com/" target="_blank">xhEditor.com</a>. All rights reserved.</p></div>';
        ...
        this.uploadInit = function (jText, tourl, upext) {
            ...
            if (tourl.substr(0, 1) == '!')//自定义上传管理页
            {
                jUpBtn.click(function () {
                    ...
                    _this.showIframeModal('上传文件', tourl.substr(1), setUploadMsg, null, null, function () {
                        bShowPanel = true;
                    });
                });
            }
            ...
            function startUpload(fromfiles) {
                ...
                bShowPanel = false;//防止按钮面板被关闭
                _this.showModal('文件上传中(Esc取消上传)', jUploadTip, 320, 150, function () {
                    bShowPanel = true;
                    upload.remove();
                });
                upload.start();
