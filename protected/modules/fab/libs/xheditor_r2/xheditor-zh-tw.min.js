...
"#00CCCC","#339999","#336666","#003333","#CCFFFF","#66FFFF","#33CCFF","#3366FF","#3333FF","#000099","#000066","#CCCCFF","#9999FF","#6666CC","#6633FF","#6600CC","#333399","#330099","#FFCCFF","#FF99FF","#CC66CC","#CC33CC","#993399","#663366","#330033"],Qa=[{n:"p",t:"\u666e\u901a\u6bb5\u843d"},{n:"h1",t:"\u6a19\u984c1"},{n:"h2",t:"\u6a19\u984c2"},{n:"h3",t:"\u6a19\u984c3"},{n:"h4",t:"\u6a19\u984c4"},{n:"h5",t:"\u6a19\u984c5"},{n:"h6",t:"\u6a19\u984c6"},{n:"pre",t:"\u5df2\u7de8\u6392\u683c\u5f0f"},{n:"address",
t:"\u5730\u5740"}],Ra=[{n:"\u65b0\u7d30\u660e\u9ad4",c:"PMingLiu"},{n:"\u7d30\u660e\u9ad4",c:"mingliu"},{n:"\u6a19\u6977\u9ad4",c:"DFKai-SB"},{n:"\u5fae\u8edf\u6b63\u9ed1\u9ad4",c:"Microsoft JhengHei"},{n:"Arial"},{n:"Arial Narrow"},{n:"Arial Black"},{n:"Comic Sans MS"},{n:"Courier New"},{n:"System"},{n:"Times New Roman"},{n:"Tahoma"},{n:"Verdana"}],P=[{n:"xx-small",wkn:"x-small",s:"8pt",t:"\u6975\u5c0f"},{n:"x-small",wkn:"small",s:"10pt",t:"\u7279\u5c0f"},{n:"small",wkn:"medium",s:"12pt",t:"\u5c0f"},
{n:"medium",wkn:"large",s:"14pt",t:"\u4e2d"},{n:"large",wkn:"x-large",s:"18pt",t:"\u5927"},{n:"x-large",wkn:"xx-large",s:"24pt",t:"\u7279\u5927"},{n:"xx-large",wkn:"-webkit-xxx-large",s:"36pt",t:"\u6975\u5927"}],Sa=[{s:"\u9760\u5de6\u5c0d\u9f4a",v:"justifyleft"},{s:"\u7f6e\u4e2d",v:"justifycenter"},{s:"\u9760\u53f3\u5c0d\u9f4a",v:"justifyright"},{s:"\u5de6\u53f3\u5c0d\u9f4a",v:"justifyfull"}],Ta=[{s:"\u6578\u5b57\u5217\u8868",v:"insertOrderedList"},{s:"\u7b26\u865f\u5217\u8868",v:"insertUnorderedList"}],
...
d('<div style="width:200px;word-wrap:break-word;word-break:break-all;"><p><span style="font-size:20px;color:#1997DF;">xhEditor</span><br />v1.0.0 rc2 build 100401</p><p>xhEditor\u662f\u4e00\u500b\u57fa\u65bcjQuery\u958b\u767c\u7684\u8de8\u5e73\u53f0\u958b\u6e90\u8ff7\u4f60XHTML\u7de8\u8f2f\u5668\u7d44\u4ef6\u3002</p><p><a href="http://xheditor.com/" target="_blank">http://xheditor.com/</a></p></div>');b.showDialog(a)};this.attr=function(a,c,e){if(!c)return false;var h="_xhe_"+c;e&&a.attr(c,e).removeAttr(h).attr(h,
...
m,null,null,function(){R=true})});else{k.append('<input type="file" class="xheFile" size="13" name="filedata" tabindex="-1" />');var n=d(".xheFile",k);n.change(function(){var j=n.val();if(j!="")if(j.match(new RegExp(".("+e.replace(/,/g,"|")+")$","i"))){R=false;var f;f=new b.ajaxUpload(n,c,function(g){b.removeModal();g.err?alert(g.err):m(g.msg)},function(){b.removeModal()});b.showModal("\u6587\u4ef6\u4e0a\u50b3\u4e2d(Esc\u53d6\u6d88\u4e0a\u50b3)",'<div style="margin:22px 0;text-align:center;line-height:30px;">\u6587\u4ef6\u4e0a\u50b3\u4e2d\uff0c\u8acb\u7a0d\u5019\u2026\u2026<br /><img src="'+
Aa+'img/loading.gif"></div>',320,150,function(){R=true;f.remove()});f.start()}else alert("\u4e0a\u50b3\u6587\u4ef6\u64f4\u5c55\u540d\u5fc5\u9700\u70ba: "+e)})}};this.ajaxUpload=function(a,c,e,h){var m="jUploadFrame"+(new Date).getTime(),k=this,p=d('<iframe name="'+m+'" class="xheHideArea" />').appendTo("body"),n=d('<form action="'+c+'" target="'+m+'" method="post" enctype="multipart/form-data" class="xheHideArea"></form>').appendTo("body"),j=d(a),f=j.clone().attr("disabled","true");j.before(f).appendTo(n);
this.remove=function(){if(k!=null){f.before(j).remove();p.remove();n.remove();k=null}};this.onLoad=function(){var g=d(p[0].contentWindow.document.body).text(),i=Object;k.remove();try{i=eval("("+g+")")}catch(l){}if(i.err!=undefined&&i.msg!=undefined)e(i);else{alert(c+" \u4e0a\u50b3\u63a5\u53e3\u767c\u751f\u932f\u8aa4\uff01\r\n\r\n\u8fd4\u56de\u7684\u932f\u8aa4\u5167\u5bb9\u70ba: \r\n\r\n"+g);h()}};this.start=function(){n.submit();p.load(k.onLoad)};return this};this.showIframeModal=function(a,c,e,h,
...
j=b.settings.layerShadow;k=d('<div class="xheModal" style="width:'+(e-1)+"px;height:"+h+"px;margin-left:-"+Math.ceil(e/2)+"px;"+(y&&ta<=7?"":"margin-top:-"+Math.ceil(h/2)+"px")+'">'+(b.settings.modalTitle?'<div class="xheModalTitle"><span class="xheModalClose" title="\u95dc\u9589 (Esc)"></span>'+a+"</div>":"")+'<div class="xheModalContent"></div></div>').appendTo("body");n=d('<div class="xheModalOverlay"></div>').appendTo("body");if(j>0)p=d('<div class="xheModalShadow" style="width:'+k.outerWidth()+
...
if(L==null){L={};var e=C.find(".xheButton[name="+a+"]");if(e.length==1)L.target=e}if(c.e){c.e.call(b);return L=null}a=a.toLowerCase();switch(a){case "cut":try{s.execCommand(a);if(!s.queryCommandSupported(a))throw"Error";}catch(h){alert("\u60a8\u7684\u700f\u89bd\u5668\u5b89\u5168\u8a2d\u7f6e\u4e0d\u5141\u8a31\u4f7f\u7528\u526a\u4e0b\u64cd\u4f5c\uff0c\u8acb\u4f7f\u7528\u9375\u76e4\u5feb\u6377\u9375(Ctrl + X)\u4f86\u5b8c\u6210")}break;case "copy":try{s.execCommand(a);if(!s.queryCommandSupported(a))throw"Error";
}catch(m){alert("\u60a8\u7684\u700f\u89bd\u5668\u5b89\u5168\u8a2d\u7f6e\u4e0d\u5141\u8a31\u4f7f\u7528\u8907\u88fd\u64cd\u4f5c\uff0c\u8acb\u4f7f\u7528\u9375\u76e4\u5feb\u6377\u9375(Ctrl + C)\u4f86\u5b8c\u6210")}break;case "paste":try{s.execCommand(a);if(!s.queryCommandSupported(a))throw"Error";}catch(k){alert("\u60a8\u7684\u700f\u89bd\u5668\u5b89\u5168\u8a2d\u7f6e\u4e0d\u5141\u8a31\u4f7f\u7528\u8cbc\u4e0a\u64cd\u4f5c\uff0c\u8acb\u4f7f\u7528\u9375\u76e4\u5feb\u6377\u9375(Ctrl + V)\u4f86\u5b8c\u6210")}break;
