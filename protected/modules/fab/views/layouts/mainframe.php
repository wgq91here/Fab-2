...
<frameset rows="80,*" frameborder="0" border="0">
  ...
  <frame noresize="noresize" src="<?php echo Yii::app()->createurl('/fab/admin/topmenu'); ?>" name="topmenu_iframe" id="topmenu_iframe" scrolling="NO">

<frameset cols="200,*" frameborder="0" name="ciframe" id="ciframe">
  <frame noresize="noresize" src="<?php echo Yii::app()->createurl('/fab/help/leftmenu'); ?>" name="left_iframe" id="left_iframe" scrolling="scroll" style="overflow-x: hidden;">
  <frame noresize="noresize" src="<?php echo $content; ?>" name="content_iframe"  id="content_iframe" scrolling="scroll" style="overflow-x: hidden;">
</frameset>
