...
<tr>
<td id="bottomtd" colspan="2" bgcolor="#CFDDF8"><h5><?php echo Yii::t("FabModule.fab", "Login"); ?></h5></td>
</tr>
...
<tr>
	...
	<?php echo CHtml::activeLabelEx($model,'rememberMe'); ?>
	 | 
	<?php echo CHtml::link(Yii::t("FabModule.fab", "Registration"),Yii::app()->User->registrationUrl); ?> | <?php echo CHtml::link(Yii::t("FabModule.fab", "Lost Password?"),Yii::app()->User->recoveryUrl); ?>
	</td>
</tr>
<tr>
<td id="bottomtd" colspan="2" style="text-align:right"><?php echo CHtml::submitButton(Yii::t("FabModule.fab", "Login")); ?></td>
</tr>
