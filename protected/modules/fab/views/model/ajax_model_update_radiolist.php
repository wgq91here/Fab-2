        ...
        foreach ($fmClass->getAttribute('Data') as $key => $option):
            ...
            <div id="<?php echo $_KEY; ?>">
                ...
                &nbsp;<A HREF="javascript:void(null);"
                         onclick="insertradiolist('<?php echo $fmClass->uniquerID; ?>',$(this));">[insert]</A>
                &nbsp;<A HREF="javascript:void(null);"
                         onclick="deleteradiolist('<?php echo $fmClass->uniquerID; ?>',$(this));">[delete]</A>
                <?php
                $_selectCssClass = ($key == $_Select) ? "selected" : "unselect";
                $_selectValue = ($key == $_Select) ? "[unselect]" : "[select]";
                ?>
                &nbsp;<A name="radiolistSelect" class="<?php echo $_selectCssClass; ?>" HREF="javascript:void(null);"
                         onclick="selectedradiolist('<?php echo $fmClass->uniquerID; ?>',$(this));"><?php echo $_selectValue; ?>
                </A>
            </div>
        <?php endforeach; ?>
    </div>
