...
?>
&nbsp;<A HREF="javascript:void(null);" onclick="insertCheckbox('<?php echo $fmClass->uniquerID; ?>',$(this));">[insert]</A>
&nbsp;<A HREF="javascript:void(null);" onclick="deleteCheckbox('<?php echo $fmClass->uniquerID; ?>',$(this));">[delete]</A>
<?php
$_selectCssClass = (in_array($key, $_Select))?"selected":"unselect";
$_selectValue = (in_array($key, $_Select))?"[unselect]":"[select]";
?>
&nbsp;<A name="checkboxSelect" class="<?php echo $_selectCssClass; ?>" HREF="javascript:void(null);" onclick="selectedCheckbox('<?php echo $fmClass->uniquerID; ?>',$(this));"><?php echo $_selectValue; ?>
</A>
</div>
<?php endforeach; ?>
</div>
