<style type="text/css">
    ...
    body {
        /* background: url("
    <?php echo FController::getAssetImagePath(); ?> bg.png");
    ...
    .ftool {
        /* background:url("
    <?php echo FController::getAssetImagePath(); ?> fieldstoolbg.png") no-repeat scroll center top transparent; */
        margin-top: 3px;
        padding-bottom: 5px;
        display: none;
    ...
    <?php //echo FController::getAssetImagePath(); ?>
        2008070304-01.png');
    ...
    <div class="container_24">
        ...
        <div id="modelContent" class="grid_14">
            <div style="padding:6px;margin-top:5px;background-color:yellow;">
                递交地址:
                <strong><?php echo 'http://' . $_SERVER['HTTP_HOST'] . Yii::app()->createUrl('fab/model/submit', array('id' => $_Form_UniqueId)); ?></strong>
            </div>
            <div style="height:30px;padding:3px;font-size:14px;margin-top: 8px;">
                ...
                <span id="Formtitle_lable" onclick="$(this).hide();$('#FormTitleDIV').show();"
                ...
                <div style="padding:10px;" class="buttons">
                    ...
                    <ul style="">
                        <?php foreach ($fieldModels as $field): ?>
                            <LI style="float: left;margin-bottom: 5px; cursor: pointer;text-align:left;"
                                class='button wide'
                                onclick="model_ajax('<?php echo $this->createurl('loadfield', array('ajax' => true, 'modelFieldType' => $field['nameID'])); ?>');">
