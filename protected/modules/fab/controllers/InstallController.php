<?php
class InstallController extends FController
{
    public function actionIndex()
    {
        $this->redirect($this->createurl('do'));
    }
    ...
    public function actionDo()
    {
        if (Yii::app()->request->isPostRequest) {
            ...
            $this->install();
            $this->webMessage('Install is success !', $this->createUrl('admin/'));
            return;
        }
    ...
    private function install()
    {
        ...
        $usersTable = Yii::app()->controller->module->usersTable;
        $messagesTable = Yii::app()->controller->module->messagesTable;
        $profileFieldsTable = Yii::app()->controller->module->profileFieldsTable;
        $profileTable = Yii::app()->controller->module->profileTable;
        $rolesTable = Yii::app()->controller->module->rolesTable;
        $userRoleTable = Yii::app()->controller->module->userRoleTable;
